...
$dance_db = "aishangsalsa"; // 数据库名称（在用户体验版和正式发布版中，$dance_db = "aishangsalsa"）
$dance_db_backup = "aishangsalsa_backup"; // 备份数据库名称（在用户体验版和正式发布版中，$dance_db_backup = "aishangsalsa_backup"）
